...
const tutorialSections = [
    ...
    - • Uurimisel aitab see teada, kes dokumendi lõi, kas seda on hiljem muudetud ja mida täpselt kaasati PDF-i sisse.`
      },
      {
        id: 3,
    ...
    - • Iga rida logifailis sisaldab **ajatemplit** (kuupäev ja kellaaeg), mis ütleb täpselt, millal midagi toimus (näiteks “2025-05-30 09:12:45 – kasutaja sisestas vale parooli”).  
    ...
    - • Igal meilil on **päis** (header), kus on kirjas saatja ja saaja aadressid, kellaaeg, serverite nimed ja muud tehnilised andmed (näiteks “From: kasutaja@example.com” või “Received: server123.mail.com”).  
    ...
    - • Kui keegi saadab e-kirja, salvestub see serveris ja kliendi arvutis faili kujul. Sa võid selle faili avada spetsiaalses e-posti programmis või tavatekstina lugeda, et näha, kes saatja on, millal see saadeti ja mis manuseid kaasas oli.  
