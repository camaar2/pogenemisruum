...
const tutorialSections = [
  ...
  - • Nii peatad ründaja katse ja kaitsed teisi süsteeme, mitte ei lase pahavaral edasi liikuda.`
    ...
    {
      id: 3,
      title: "Kasutajakontode ohtude käsitlemine",
      content: `
  ...
  - • Kui avastad, et mõne kasutajakonto andmed on lekkinud või keegi on sisse logitud ilma õigusteta, lukustad kontod, et ära hoida edasisi rünnakuid ja sunnid kasutajaid uute paroolide loomisele.  
  ...
  - • Kui kasutaja parool sai kellegi teise käes lekkida, ei tohiks ta selle parooliga enam juurde pääseda. Antud juhul tuleks kõigile anda uued ja jõulisemad paroolid.  
  - • Seda tehakse, sundides kasutajaid kasutama uusi paroole, mis on piisavalt keerukad (vähemalt 8 tähemärki, suured ja väikesed tähed, numbrid, sümbolid) ja ei lange olemasoleva lekkeloendiga kokku.  
  - • Lisaks võib esineda korduvaid soovitusi: nõuda paroolivahetust iga 90 päeva järel, et piirata riski, kui kasutajad unustavad paroole turvaliselt hoida.`
    },
    {
      id: 5,
  ...
  - • Logid on nagu mustkast – kui need kustutad, ei saa enam teada, mis täpselt juhtus, ja ei saa vaadata, kes mida tegi ega millal.  
  - • Kui logid ära kaovad, ei saa turvameeskond kindlaks teha intsidendi algpõhjust (nt mis IP-aadress proovis sisse logida) ega koostada täpset ajajoont (millal ja mis süsteemides toimus).  
  ...
  - • Kui vool läheb ära ja sa käivitad auto kohe uuesti, ei tea keegi, mis enne juhtus, sest info kaob. Sama juhtub arvutitega – kui lased re-bootida, kaovad olulised ajutised andmed.  
