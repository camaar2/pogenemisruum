...
const tutorialSections = [
  ...
  - • **Eelis masskampaania ees:** mass-õngitsus saadab identse kirja tuhandetele inimestele korraga, nii et kui sõnum sind ei puuduta või on arusaadavalt mitte asjakohane, võivad paljud seda ignoreerida. Spear-phishingu puhul tundub kiri personaalsem ja ahvatlevam, mistõttu töötaja võib reageerida kiiremini ja tahtmatult riskida.  
  - • **Eesmärk on tuvastada eelkõige kallimaid sihtmärke** (nt finantsjuht, IT-administraator), kes omavad suuremaid õigusi, et õpitu põhjal kohandada täiendavad turvameetmed.`
    ...
    {
      id: 3,
      title: "Õngitsuskampaania üldine lähenemine",
      content: `
  - **Mass-kampaania** tähendab, et saadad identse petukirja (nt pangateavituse või Microsofti turvateate) kõigile töötajatele korraga.  
    ...
    - • **Spear-phishing (sihtsuunatud kampaania)** tähendab, et saadad näiliselt korrektse kirja konkreetsele osakonnale või isikule, mis põhineb eelnevalt kogutud infol (nt keegi tõestas, et töötab IT-osakonnas ja vastutab serverite eest).  
    ...
    },
    {
      ...
      content: `
- • **Saatja aadress:** kontrolli, kas domeen pärast “@” on õige (nt “@sinu-pank.ee”) või esineb mõni väike tähevea-võltsing (nt “@sinu-pankk.ee”).
...
- • **Kahtlane sisu ja toon:** kui kiri ütleb “KIIRUSTA! KLÕPSA KOHE!” või sisaldab hüüumärke ning ähvardab kontolukustusega, on tõenäoliselt tegu petuskeemiga. 
...
- • **Manused:** kui tegemist on .exe-, .zip- või .docm-failiga, tee kontroll enne, kui avad. 
...
- • Kui kirjas on midagi ootamatut (nt “Anname sulle hüvitist” või “Tõesta oma identiteeti kohe”), sea endale reegel:  
    ...
    3. Kui oled kahtleval seisukohal, küsi abi IT-osakonnalt või tee otsing internetis, et näha, kas see kiri on tõesti õige saatja poolt saadetud.`
    }
  ];
