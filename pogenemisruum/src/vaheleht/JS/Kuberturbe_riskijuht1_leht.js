...
- • Kui ehitad maja, ei jäta sa ust lukku panemata ja kõiki aknaid lahti – samamoodi pead paigaldamisel seadma kohe tugevad paroolid ja piirangud, et keegi ei saaks neid hiljem murda.  
...
- • Kui kasutad tavapäraseid vaikeväärtusi (nt vaikekasutajanimi ja -parool), on see nagu jätaksid maja ukse lahti – ründaja leiab kiiresti, kuidas ligi pääseda.`
  },
  {
    ...
    content: `
- **Root-kasutaja** on kõrgeimate õigustega konto Linux/Unix süsteemis, mis võib muuta kõiki sätteid ja faile (seda võid ette kujutada kui maja võtit, mis avab igat ust).  
...
-  Parool peaks olema:
  ...
  - • Kui parool on lühike või ainult sõna (“salasõna”), on see nagu lihtne tabalukk, mida saab tuntud võtmega avada. Kui aga kasutad keerulisemat kombinatsiooni, on ründajal vaja palju rohkem aega katsete tegemiseks (nt “Kass!2025$Tugev” vs “salasõna”).  
...
- • Kui kasutad **ainult parooli**, on see nagu üks lukustusvõti – ründaja võib proovida järjest seda kopeerida. SSH võtmegeneratsiooniga on aga iga seanss unikaalne ja ründajal on võimatu ära arvata (kui privaatvõti on turvaliselt hoitud).  
- **Kuidas seadistada?**  
...
- Turvalisuse tõstmiseks:  
  ...
  3. **Logide monitooring** &ndash; jälgi SSH sisselogimiskatseid. Kui näed palju valesid katseid, võid blokeerida selle IP või saata teavituse.  
