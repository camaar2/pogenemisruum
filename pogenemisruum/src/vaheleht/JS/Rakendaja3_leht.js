...
- **Port** on nagu “uks” väljaspool arvutit: iga port võimaldab eri tüüpi andmeedastust (näiteks port 80 veebilehtede jaoks, port 22 kaugjuurdepääsu jaoks).  
...
- • Õigesti konfigureeritud tulemüür aitab vältida, et ründajad pääseksid süsteemile ligi ja et pahavara ei saaks andmeid internetti saata.`
},
{
    id: 3,
    title: "Andmete varundussüsteem",
    content: `
- **Andmete varundussüsteem** loob korrapäraselt koopiad kõikidest olulistest failidest ja andmebaasidest, et tagada nende taastamine, kui originaalid kaotsi lähevad või neid rikutakse.  
- Varundamiseks on tavaliselt kolm varianti:  
...
- • Varukoopiaid võib hoida kas kohalikul kõvakettal, pilvesalvestuses või välisel USB-l.  
- • Mõtle, et lood päeviku koopiad – kui keegi põletab su originaalse päeviku, on sul varundus olemas, et seda taastada. Sama on andmetega: kui ründaja kustutab või krüpteerib faile, saad varukoopiast taastada algse olukorra.  
...
- • Varunduse toimivust tuleb regulaarselt testida: tee proovitaastamisi, et veenduda, kas varukoopiad töötavad õigesti.`
},
{
    id: 4,
    title: "Sissetungituvastussüsteem (IDS)",
    content: `
- **IDS (Intrusion Detection System)** on tarkvara või riistvara, mis analüüsib võrgu- või süsteemi sissekandeid, et tuvastada ebatavaline või pahatahtlik tegevus.  
