...
const tutorialSections = [
  ...
  - • **Turvameeskond** on grupp inimesi, kes jälgib ja kaitseb süsteeme rünnakute eest (nagu “politsei” arvutimaailmas).  
  ...
  - • **Mõju** tähendab, kui suurt kahju see võib põhjustada (nt kas varastati isikuandmeid või lihtsalt ei lae üks veebileht).  
  ...
  - • See meeskond jagab ülesanded – keegi vaatab tehnilist poolt (rmn). keegi tegeleb kommunikatsiooniga (teavitab kliente/avalikkust) ja keegi jälgib, et vajalikud vahendid (riistvara, inimesed) on käepärast.`
    },
    {
      id: 4,
  ...
  -    3. Taastamist – süsteemi või andmete taastamine varukoopiatest (nt taastatakse andmebaas seisu enne rünnakut).`
    }
  ];
