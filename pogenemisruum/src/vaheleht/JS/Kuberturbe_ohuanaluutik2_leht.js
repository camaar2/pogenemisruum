...
const tutorialSections = [
  {
    ...
    content: `
Ohumärgid (indikaatorid) andmetes on elemente, mis viitavad pahatahtlikule tegevusele:
...
- **C2-serverid** – käsu-ja-kontroll-serverite aadressid või nimed, mida botnetid või muud pahatahtlikud projektid kasutavad, et suunata nakatatud seadmeid ja juhtida rünnakuid
`
  },
  {
    id: 2,
...
- • Tekivad kahtlased faililaiendid (\`.exe\`, \`.dll\`, \`.js\`, \`.sh\`) või failinimed, mis ei ole tavapärased (näiteks \`setup_backdoor.exe\`).  
...
- • Tõenäoliselt mainitakse C2-aadresse (käsu-ja-kontrollserverid), mis koosnevad tihti IP-aadressist või kahtlasest alamdomeenist.  
  ...
  **Kokkuvõttes**: kui tekst koosneb lihtsalt üldistest sõnadest ja lausetest, on see tavatekst. Kui aga tekib mingi kindel mustriline või vormiline eripära (IP-aadressid, failihashid, domeenid, kahtlased failinimed), siis on tõenäoliselt tegemist ohumärgiga.`
  },
  {
    id: 3,
